...
import SheepModel from "@/components/SheepModel";
...
export default function SheepPreview() {
    ...
    <div style={{ width: "100%", height: "100%", position: "relative" }}>
      <Canvas camera={{ position: [3.5, 2.8, 3.5], fov: 50 }} shadows gl={{ antialias: true }}>
        <Suspense fallback={null}>
          ...
          <HexTile position={[0, 0, 0]} color="#7ec850" height={0.28} seed={37} />
          <SheepModel scale={scale} position={[0, yOffset, 0]} />
