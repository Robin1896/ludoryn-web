...
export const metadata: Metadata = {
  ...
  description: "Speel bordspellen online met vrienden — Grub, Kriskras, Basteon en meer. Direct in de browser, geen app nodig.",
  keywords: ["bordspel", "online bordspel", "Wormenjacht", "Kriskras", "Basteon", "multiplayer", "spel met vrienden"],
  ...
  openGraph: {
    ...
    description: "Speel bordspellen online met vrienden — Grub, Kriskras, Basteon en meer.",
    url: APP_URL,
